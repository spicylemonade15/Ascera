...
import { getPitchedInvestors } from '../api/apiPitch';
 ...
 if(!isLoaded){
  ...
  return (
    <div>
      ...
      <Input type="text" placeholder="Search Investors by Title.." name="search-query" className="h-full flex-1 px-4 text-md"/>
